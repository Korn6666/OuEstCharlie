...
void GameManager::majVectors() 
{
	...
	for (auto& cell : livingCells) {
		...
		if ( m < grid.size() - 3 && n < grid.size() - 3 && m > 2 && n > 2 && !grid[m][n]->isAlive())
